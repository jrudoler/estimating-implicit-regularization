...
def train_model(model, run_name, dropout_rate, max_epochs=25, early_stopping=False, patience=3):
...
if __name__ == "__main__":
    ...
    train_model(model, args.run_name, args.dropout_rate, args.max_epochs, args.early_stopping, args.patience)
