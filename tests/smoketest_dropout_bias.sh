#!/bin/bash
# Smoketest script for dropout_bias_l2_estimation.py
...
echo "Running smoketest for dropout_bias_l2_estimation.py..."
echo "This will use minimal settings (2 epochs training, 5 epochs bias estimation)"
echo ""

uv run python analysis/dropout_bias_estimation.py \
